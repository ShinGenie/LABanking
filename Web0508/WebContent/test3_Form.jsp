...
<div style="width:800px">
  <form name="myform"  method="get" action="test3_Save.jsp">
    <fieldset>
    	<legend>test3_Form.jsp</legend>
    	<div class="input_group">
    		<label>이름:</label>
    		<input type=text name="user_name" value="1234" />
    	</div>
    	
    	<div class="input_group">
    		<label>주번:</label>
    		<input type=text name="user_pwd" onkeyup="pwdNumber();"  />
    	</div>
    	...
    	<div class="input_group">
        	...
        	<select name="job">
        	  <option>----선택하세요----</option>
        	  <option value="dev" selected="selected">프로그램개발자 </option>
        	  <option value="pub">퍼블리셔 </option>
        	  <option value="DBA">DB관리자 </option>
        	  <option value="DBA">IOT개발자 </option>
        	</select>
    	</div>
    	...
    	<div class="input_group">
    		<label>파일:</label>
    		<label> <input type="file" name="myfile" size=10> </label>
    	</div>
