...
<title> [test_form5.jsp]</title>
 ...
 /////////////////////////////////////////////////////////////////////////
 	...
 	function pwdNumber(){
 	  ...
 	  //두번째 특정위치문자 한글자체크   charAt(위치)
 	  //세번째 문자열추출 substring(시작위치,끝위치) 아니면 substr(시작위치,끝위치)
 	  //네번째 키이벤트적용 onKeyUp
 	  //5번째 isNaN(숫자나 문자열) :입력값이 숫자인지 문자인지 판별하여 숫자가 아니면 true값 반환
...
<div style="width:800px">
  <form name="myform"  action="test_form5Save.jsp">
    <fieldset>
